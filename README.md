...
| Nr. | Datei | Inhalt |
|-----|-------|----------|
| **01** | [Biografie.md](01_Biografie.md) | Lebenslauf, politischer Werdegang, GegenUni, Ausstieg |
| **02** | [TikTok_Strategie.md](02_TikTok_Strategie.md) | AfD-Social-Media-Strategie, Ahrens-Methode, Werbedeals |
| **03** | [Undercover_Enthuellungen.md](03_Undercover_Enthuellungen.md) | Athen 2023, Potsdam 2023, WerteUnion-Affäre |
...
## Kurzprofil Erik Ahrens

| Kategorie | Information |
|-----------|-------------|
| **Name** | Erik Ahrens |
| **Geburtsdatum** | 27. Juli 1994 |
| **Rolle** | Ex-AfD-TikTok-Stratege, Whistleblower |
| **Status** | Seit Sept. 2025 ausgestiegen |
| **Bekannt für** | TikTok-Strategie, Undercover-Enthüllungen |

---

## Wichtige Hinweise

- Alle Angaben sind **evidenzbasiert** mit Originalquellen belegt
